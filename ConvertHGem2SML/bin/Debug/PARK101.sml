CarrierReleaseComplete: 'S6F11' W /* 5102 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5102 >  /*CarrierReleaseComplete*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
					<U1 [1] 0 >  /*PortID*/
					<A [9] 'CarrierID' > /*CarrierID*/
					<U2 [1] 0 >  /*PortSampleSize*/
				 > 
			 > 
		 > 
	 > 
.
DockComplete: 'S6F11' W /* 5103 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5103 >  /*DockComplete*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
CarrierIDRead_Fail: 'S6F11' W /* 5015 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5015 >  /*CarrierIDRead_Fail*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
CarrierIDRead: 'S6F11' W /* 5001 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5001 >  /*CarrierIDRead*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
xCarrierIDRead_300: 'S6F11' W /* 5007 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5007 >  /*xCarrierIDRead_300*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
Occupied_SubstLoc: 'S6F11' W /* 6025 */
	<L 
		<U4 [1] 0>
		<U4 [1] 6025 >  /*Occupied_SubstLoc*/
		<L 
			<L 
				<U2 [1] 92 >  /*Occupied*/
				<L 
					<A [10] 'SubstLocID' > /*SubstLocID*/
					<U1 [1] 0 >  /*SubstLocState*/
					<A [7] 'WaferID' > /*WaferID*/
				 > 
			 > 
		 > 
	 > 
.
Unoccupied_SubstLoc: 'S6F11' W /* 6026 */
	<L 
		<U4 [1] 0>
		<U4 [1] 6026 >  /*Unoccupied_SubstLoc*/
		<L 
			<L 
				<U2 [1] 92 >  /*Occupied*/
				<L 
	 ...
	 > 
.
AccessModeChange_AUTO: 'S6F11' W /* 5035 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5035 >  /*AccessModeChange_AUTO*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
AccessModeChange_Manual: 'S6F11' W /* 5036 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5036 >  /*AccessModeChange_Manual*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
...
PortDown: 'S6F11' W /* 5023 */
	<L 
	 ...
	 > 
.
GemPPChangeEvent: 'S6F11' W /* 12 */
	<L 
		<U4 [1] 0>
		<U4 [1] 12 >  /*GemPPChangeEvent*/
		<L 
			<L 
				<U2 [1] 41 >  /*PPChange*/
				<L 
					<A [12] 'PPChangeName' > /*PPChangeName*/
					<U1 [1] 0 >  /*PPChangeStatus*/
				 > 
			 > 
		 > 
	 > 
...
WaferEnd: 'S6F11' W /* 61 */
	<L 
		...
		<L 
			<L 
				<U2 [1] 91 >  /*MeasuredData*/
				<L 
					<A [7] 'WaferID' > /*WaferID*/
					<U4 [1] 0 >  /*TipSampleCount*/
					<U4 [1] 0 >  /*TipApproachCount*/
					<F4 [1] 0 >  /*TipMileage*/
					<F4 [1] 0 >  /*TipWidth*/
					<F4 [1] 0 >  /*TipHeight*/
					<F4 [1] 0 >  /*TipRatio*/
					<A [5] 'TipID' > /*TipID*/
					<U1 [1] 0 >  /*TipPortNumber*/
					<U1 [1] 0 >  /*TipSlotNumber*/
				 > 
			 > 
		 > 
	 > 
.
SlotMapResult: 'S6F11' W /* 5009 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5009 >  /*SlotMapResult*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
ReadyToUnload: 'S6F11' W /* 5031 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5031 >  /*ReadyToUnload*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
ReadyToLoad: 'S6F11' W /* 5030 */
	<L 
		<U4 [1] 0>
		<U4 [1] 5030 >  /*ReadyToLoad*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
LoadComplete: 'S6F11' W /* 41 */
	<L 
		<U4 [1] 0>
		<U4 [1] 41 >  /*LoadComplete*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
UnloadComplete: 'S6F11' W /* 42 */
	<L 
		<U4 [1] 0>
		<U4 [1] 42 >  /*UnloadComplete*/
		<L 
			<L 
				<U2 [1] 87 >  /*LoadPortInfo*/
				<L 
	 ...
	 > 
.
CJStatusChange_Queue: 'S6F11' W /* 7001 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7001 >  /*CJStatusChange_Queue*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
					<A [9] 'CtrlJobID' > /*CtrlJobID*/
					<U1 [1] 0 >  /*CtrlJobState*/
				 > 
			 > 
		 > 
	 > 
.
CJStatusChange_Select: 'S6F11' W /* 7003 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7003 >  /*CJStatusChange_Select*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
ControlJobStart: 'S6F11' W /* 7005 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7005 >  /*ControlJobStart*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
CJStatusChange_WaitForStart: 'S6F11' W /* 7006 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7006 >  /*CJStatusChange_WaitForStart*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
CJStatusChange_Paused: 'S6F11' W /* 7008 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7008 >  /*CJStatusChange_Paused*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
ControlJobEnd: 'S6F11' W /* 7010 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7010 >  /*ControlJobEnd*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
CJStatusChange_Stopped: 'S6F11' W /* 7011 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7011 >  /*CJStatusChange_Stopped*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
CJStatusChange_Aborted: 'S6F11' W /* 7012 */
	<L 
		<U4 [1] 0>
		<U4 [1] 7012 >  /*CJStatusChange_Aborted*/
		<L 
			<L 
				<U2 [1] 94 >  /*CJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Pool: 'S6F11' W /* 4001 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4001 >  /*PJStatusChange_Pool*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
					<A [12] 'ProcessJobID' > /*ProcessJobID*/
					<U1 [1] 0 >  /*ProcessJobStatus*/
					<A [8] 'RecipeID' > /*RecipeID*/
				 > 
			 > 
		 > 
	 > 
.
PJStatusChange_SETTING: 'S6F11' W /* 4002 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4002 >  /*PJStatusChange_SETTING*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_WaitingForStart: 'S6F11' W /* 4003 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4003 >  /*PJStatusChange_WaitingForStart*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
ProcessJobStart: 'S6F11' W /* 4004 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4004 >  /*ProcessJobStart*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
ProcessJobEnd: 'S6F11' W /* 4006 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4006 >  /*ProcessJobEnd*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Pausing: 'S6F11' W /* 4010 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4010 >  /*PJStatusChange_Pausing*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Paused: 'S6F11' W /* 4011 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4011 >  /*PJStatusChange_Paused*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Stopping: 'S6F11' W /* 4013 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4013 >  /*PJStatusChange_Stopping*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Aborting: 'S6F11' W /* 4015 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4015 >  /*PJStatusChange_Aborting*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Aborted: 'S6F11' W /* 4018 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4018 >  /*PJStatusChange_Aborted*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
PJStatusChange_Stopped: 'S6F11' W /* 4019 */
	<L 
		<U4 [1] 0>
		<U4 [1] 4019 >  /*PJStatusChange_Stopped*/
		<L 
			<L 
				<U2 [1] 40 >  /*PJInfo*/
				<L 
	 ...
	 > 
.
xSlotMapResult_200: 'S6F11' W /* 43 */
	<L 
		<U4 [1] 0>
		<U4 [1] 43 >  /*xSlotMapResult_200*/
		<L 
			<L 
				<U2 [1] 143 >  /*SlotMapInfo_200*/
				<L 
					<U1 [1] 0 >  /*PortID*/
					<A [9] 'CarrierID' > /*CarrierID*/
					<A [13] 'SlotMapString' > /*SlotMapString*/
				 > 
			 > 
		 > 
	 > 
